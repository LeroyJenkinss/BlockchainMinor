...
if __name__ == "__main__":
    ...
    print('now server client model:\n ------------')

    print(f'This is the reply: {Clients().sendMethod(B1)}')
    print(f'This is the reply: {Clients().sendMethod(B3)}')
    print(f'This is the reply: {Clients().sendMethod(B4)}')
    print(f'This is the reply: {Clients().sendMethod(B5)}')
